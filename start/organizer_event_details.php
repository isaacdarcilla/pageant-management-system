    ...
    <div class="col-sm-6 text-sm-right">
      <div class="m-y-sm">
        <div class="btn-group dropdown">
              <a href="organizer_generate_ticket.php?sponsor_id=<?php echo $sponsor_id ?>&username=<?php echo $username ?>&event_id=<?php echo $event_id?>"><button class="btn white btn-sm "><span class="fa fa-qrcode"></span>&nbsp&nbsp Ticketing & Audience</button></a>
...
<div class="padding timeline-center">
  <ul class="timeline">
    <li class="tl-header">
      <div class=white">Event Tree</div>
    </li>
    <li class="tl-item">
      <div class="">
    ...
    <li class="tl-item">
      <div class="tl-wrap b-success">
        <div class="tl-content box-color text-color  p-a-sm">
          ...
          <div>Event Name <span class="text-primary"><br><h3><?php echo $rowEventName['event_name'] ?>&nbsp<?php print date("Y", time()); ?></h3></span></div>
        </div>
      </div>
    </li>
    <li class="tl-item tl-left">
      <div class="tl-wrap b-primary">
        <div class="tl-content box-color primary p-a-sm">
          ...
          <div class="text-lt">Use this event code to access the judge panel <br><h3><span class=""><?php echo $rowEventName['event_code'] ?></span></h3> </div>
        </div>
      </div>
    </li>
    <li class="tl-item">
      <div class="tl-wrap b-success">
        <div class="tl-content box-color text-color  p-a-sm">
          <span class="arrow b-white left pull-top"></span>
          <div>The event will be held at the <span class="text-warning"><br><h3><?php echo $rowEventName['event_location'] ?></h3></span></div>
        </div>
      </div>
    </li>
    <li class="tl-item">
      <div class="tl-wrap b-primary">
        ...
        <div class="tl-content box-color primary p-a-sm">
          <span class="arrow b-primary left pull-up hidden-left"></span>
          <span class="arrow b-primary right pull-up visible-left"></span>
          <div class="text-lt">On <br><span class=""><h3><?php echo  date('F j , Y', strtotime(str_replace('-','/',$rowEventName['event_date']))) ?></h3></span> </div>
        </div>
      </div>
    </li>
    <li class="tl-item tl-left">
      <div class="tl-wrap b-warning">
        <div class="tl-content box-color warning p-a-sm">
          <span class="arrow b-warning left pull-top hidden-left"></span>
          <span class="arrow b-warning right pull-top visible-left"></span>
          <div class="text-lt">At exactly <br><h3><span class=""><?php echo $rowEventName['event_time'] ?></span></h3> </div>
        </div>
      </div>
    </li>
    ...
    <li class="tl-item tl-left">
      <div class="tl-wrap b-warn">
        ...
        <div class="tl-content box-color text-color p-a-sm">
          ...
          <div class="text-lt">See you there!</div>
        </div>
      </div>
    </li>
  ...
  <ul class="timeline">
    <li class="tl-header">
      <div class=white">Judge Tree</div>
    </li>
    <li class="tl-item">
      <div class="">
        <div class="tl-content">
    ...
    <li class="tl-item">
      <div class="tl-wrap b-success">
        <div class="tl-content box-color text-color  p-a-sm">
          <span class="arrow b-white left pull-top"></span>
          <div>Introduction <span class="text-primary"><br><h3><?php echo $rowJudge['first_name'] ?>&nbsp<?php echo $rowJudge['middle_name'] ?>&nbsp<?php echo $rowJudge['sur_name'] ?>
          </h3></span>
          <p >a <strong class="text-primary">selected <?php echo strtolower($rowJudge['sex']) ?></strong> judge and 
            a <b><?php echo $rowJudge['profession']  ?></b>.
          </p>
        </div>
      </div>
     </div> 
    ...
    <li class="tl-item tl-left">
      <div class="tl-wrap b-primary">
        <div class="tl-content box-color primary p-a-sm">
          <span class="arrow b-primary left pull-top hidden-left"></span>
          <span class="arrow b-primary right pull-top visible-left"></span>
          <div class="text-lt"><?php echo $rowJudge['first_name'] ?> can be contacted via email<br><h3><span class=""><?php echo $rowJudge['email'] ?></span></h3><p>or phone via <strong class="text"><?php echo $rowJudge['phone_number'] ?></strong></p></div>
        </div>
      </div>
    </li>
    <li class="tl-item">
      <div class="tl-wrap b-success">
        <div class="tl-content box-color warning  p-a-sm">
          <span class="arrow b-warning left pull-top"></span>
          <div>Use the credentials to access judge panel page<span class="text-white"><br><h3><u><?php echo $rowJudge['username'] ?></u><span style="font-size: 15px"> as username </h3></span></div>
        </div>
      </div>
    </li>
  </ul>
