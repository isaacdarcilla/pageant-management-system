...
$username = $_GET['username'];
  ...
  //  $event_org = $_POST["organization_name"];
...
$judging=$_POST['judging'];
        ...
        {
            $query_data = "INSERT INTO $db_event_table  VALUES ('NULL','$event_name', '$event_code', 
              '$event_location', '$time', '$date', '$user_id', 'NULL', '$invite_code');"; 
      ...
      // print a success message
        header("location:admin_my_event.php?user_id=$user_id&username=$username");
...
<center><h2 class=" _700 l-s-n-1x m-b-md">Create my <span class="text-primary">Event</span></h2></center>
<!-- ############ LAYOUT START-->
 ...
 <form name="form" class="form-group row pull-left" action="" method="post">
      ...
      <div class="c"><br>
        ...
        <input name="event_name" width="120px" type="text" class="form-control rounded" placeholder="Pageant Event Name" required>
      </div>
        <label class="col-sm-2 form-control-label"></label>
                ...
                <label class="col-sm-2 form-control-label"></label>
      <div class="c">
        <input type="text" name="event_location" width="120px" class="form-control rounded" placeholder="Event Location" required>
      </div>
    ...
    <div class="form-group row">
          ...
          <div class='input-group date' ui-jp="datetimepicker" ui-options="{
              ...
              <input type='text' name="event_time" required class="form-control rounded" placeholder="Time of Event"/>
      ...
      <div class="form-group">
          <div class='input-group date' ui-jp="datetimepicker" ui-options="{
              ...
              <input type='text' name="event_date" required class="form-control rounded" placeholder="Date of Event"/>
              <span class="input-group-addon">
                  <span class="fa fa-calendar"></span>
              </span>
...
<br>
     <!-- <div class=" rounded">
          <select id="single" name="judging" required="true" placeholder="Select gender" class="form-control select2 rounded" ui-jp="select2" ui-options="{theme: 'a'}">
          
          <optgroup label="Select Judging System">
            <option name="judging" value="0">Percentage System</option>
            <option name="judging" value="1">Ranking System</option>            
         ...
         <button type="submit" name="add_event" class="btn rounded  primary btn-block">Create</button>
