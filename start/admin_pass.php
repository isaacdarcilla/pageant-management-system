    ...
    <div class="box-header">
      <h2><b>Judges Data Table</b></h2>
            ...
            <ul class="nav">
              ...
              <li class="nav-item inline dropdown"> 
                    <a   class="btn btn-xs pull-right hidden-print" ><i class="fa fa-print " onclick="PrintPage();"></i>&nbsp Print</a>
              </li>
            </ul>
          </div>  
 ...
 $query = "SELECT * 
        ...
        $result = mysqli_query($connection, $query);
                ...
                <tr>
                  ...
                  <th style="width:4%" class="text-primary"> <?php echo $row['password'] ?> </th>                  
