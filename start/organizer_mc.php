  ...
  $sponsor_id = $_GET['sponsor_id'];
    ...
    if(isset($_POST['start']))
    {
        ...
        if(mysqli_affected_rows($connection)==1)
        {
            ...
            header("Location:organizer_mc_page.php?event_id=$event_id&sponsor_id=$sponsor_id&username=$username");
        } 
        else
        {
  ...
  <div class="padding">
    <h1 class="display-3 _500 l-s-n-2x" style="font-size: 40px; "><center><?php echo $rowEventName['event_name'] ?>&nbsp<?php print date("Y", time());?></b></center></h1>
      ...
      <div class="container p-y-lg text-primary-hover">
        ...
        <h5 class="text-muted m-b-lg">If you are a <b>Masters of Cemeremonies</b>, use the <b>Event Code</b> to access the page.</h5>
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <div class="box white box-shadow-z3 text-center">
                ...
                <!--  <img class="img-responsive b-b m-b" src="../assets/image.jpg" alt="default"> --><br>
                 <span class="_800 p-a block h4 m-a-0"><span class="text-muted">Event Code</span> </span>
                </a>       
