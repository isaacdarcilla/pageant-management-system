...
<!-- ############ PAGE START-->
<center><h2 class=" _700 l-s-n-1x m-b-md"> <span class="text-primary">Events</span> Data</h2></center>
<div class="padding">
  <div class="box">
    ...
    <div class="table-bordered table-hover">
      <table   class="table table-striped b-t b-b">
        <thead>
          <tr>
            <th  style="width:3%" class="text-warning">Number</th>
            <th  style="width:3%" class="text-warning">User</th>
            <th  style="width:7%" class="text-warning">Event Name</th>
       <!--     <th  style="width:10%">Sponsor Name</th> -->
            <th  style="width:6%" class="text-warning">Event Code</th>
            <th  style="width:5%" class="text-warning">Location</th>
            <th  style="width:6%" class="text-warning">Time</th>
            <th  style="width:6%" class="text-warning">Date</th>
            <th  style="width:3%" class="text-warning">Manage</th>
          </tr>
          
            <?php 
              $numberOfEntity = 0;
              $queryEventAll = "SELECT * FROM event_table WHERE created_by=$user_id";
                ...
                ?>
                <tr>
                  <th style="width:3%"> <?php echo $rowEventAll['event_id'] ?> </th>
                  <th style="width:3%"> <?php echo $rowEventAll['created_by'] ?> </th>
                 <th style="width:7%"> <?php echo $rowEventAll['event_name'] ?> </th> 
            <!--      <th style="width:7%"> <?php echo $rowEventAll['organization_name'] ?> </th> -->
                  <th style="width:6%"> <?php echo $rowEventAll['event_code'] ?> </th>
                  <th style="width:5%"> <?php echo $rowEventAll['event_location'] ?> </th>
                  <th style="width:6%"> <?php echo $rowEventAll['event_time'] ?> </th>
                  <th style="width:4%"> <?php echo $rowEventAll['event_date'] ?> </th>
                  
                  <th style="width:3%">
                  
                <div class="m-y-sm">
                    <a href="admin_add_sponsor.php?username=<?php echo $username ?>&event_id=<?php echo $rowEventAll['event_id'] ?>&user_id=<?php echo $user_id ?>  " class="btn btn-xs white"><i class="fa fa-plus"></i></a>
                    <a href="admin_contestants.php?username=<?php echo $username ?>&event_id=<?php echo $rowEventAll['event_id'] ?>&user_id=<?php echo $user_id ?>" class="btn btn-xs white btn-icon"><i class="fa fa-user "></i></a>
   <a href="admin_pass.php?username=<?php echo $username ?>&event_id=<?php echo $rowEventAll['event_id'] ?>&user_id=<?php echo $user_id ?>" class="btn btn-xs white btn-icon"><i class="fa fa-lock "></i></a>
