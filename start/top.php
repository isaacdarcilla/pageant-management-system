...
$val = $_GET['val'];
            ...
            $query = "UPDATE `contest` SET `top` = '$val' WHERE `contest`.`contest_id` = '$contest_id';";
            $result = mysqli_query($connection, $query);

              header("Location:contest.php?sponsor_id=$sponsor_id&username=$username&event_id=$event_id&contest_id=$contest_id"); 
