...
///////////
  ...
  $birthday = '';
    ...
    $password = genJudgePass();
    $pincode = $_POST["pincode"];

        if(mysqli_affected_rows($connection)>0)
        {
            $message = 'Judge already exists. Try another username.';
        }
        else
        {
            $query_data = "INSERT INTO judge_table  VALUES ('NULL','$first_name', '$middle_name', '$sur_name', '$birthday','$sex', '$email', '$phone_number', '$username2', '$password', '$pincode', '$sponsor_id');"; 
      ...
      // print a success message
        header("location:organizer_judge.php?sponsor_id=$sponsor_id&username=$username&event_id=$event_id");
                $message = 'Judge successfully registered.';
            }
        }
    }
...
<div class="padding">
<center><h2 class=" _700 l-s-n-1x m-b-md">Register a <span class="text-warning">Judge</span></h2></center>
 ...
 <form id="custom2" name="form" class="form-group column" action="" method="post">
   ...
   <div class="form-group row">
      ...
      <div class="col-sm-10">
        <div class="row">
          <div class="col-md-4">
            <input type="text" name="username2" class="form-control rounded" placeholder="Username" required>
          </div>
          <div class="col-md-3">
            <input type="password" name="pincode" data-parsley-type="integer" class="form-control rounded" placeholder="Pincode" required>
          </div>
          <div class="col-md-2">
         <button type="submit"  name="add_judge" class="btn rounded primary btn-block">Register</button>
       </div>
        </div>
      </div>
    </div><br>
