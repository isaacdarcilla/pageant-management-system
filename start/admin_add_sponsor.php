...
$event_id = $_GET['event_id'];
    ...
    $querAddSponsor = "SELECT sponsor_name, sponsor_id
                        FROM sponsor_organizer WHERE registered_by=$user_id";
    $resAddSponsor = mysqli_query($connection, $querAddSponsor);
        ...
        <div class="nav-fold">
        	<a href="">
        	    <span class="pull-left">
        	      <img src="../assets/images/b6.jpg" alt="Profile" class="w-40 img-circle">
        	    </span>
...
<!-- ############ PAGE START--><br>
<div>
<center><h2 class=" _700 l-s-n-1x m-b-md">Choose organizer for <span class="text-primary"><?php echo $rowEventName['event_name'] ?></span></h2></center>
 

        <div class="row m-y-lg padding">
          <?php 
           $querAddSponsor = "SELECT * FROM sponsor_organizer WHERE registered_by=$user_id";
            $resAddSponsor = mysqli_query($connection, $querAddSponsor);

                while ($rowSponsor = mysqli_fetch_assoc($resAddSponsor)) 
                  {
                ?>
          <div class="col-md-6 col-lg-4">
            <div class="box white box-shadow-z3 text-center">
                <a href="angular">
                  <img class="img-responsive b-b m-b" src="../assets/images/p0.jpg" alt="default">

                  <span class="_800 p-a block h4 m-a-0"><?php echo $rowSponsor['sponsor_name'] ?></span>
                  <a href="mail-to:<?php echo $rowSponsor['email'] ?>" class="text-accent"><?php echo $rowSponsor['email'] ?></a>
                
                <div class="box-body">
                  <p>
                    <span><button class="btn white"  ui-toggle-class="bounce" ui-target="#animate">
                      <i class="fa fa-fw fa-star text-muted"> </i> <?php echo $rowSponsor['position'] ?>&nbsp<?php echo $rowSponsor['in_charge'] ?></button></span>
                ...
                <div class="row-col b-t">
                  <a href="admin_my_event.php?user_id=<?php echo $user_id ?>&username=<?php echo $username ?>" class="row-cell _500 p-a b-r text-warning">View</a>
                                 
                  <a href="admin_adding_organizer.php?username=<?php echo $username ?>&event_id=<?php echo $event_id ?>&user_id=<?php  
                 echo $user_id ?>&sponsor_id=<?php echo $rowSponsor['sponsor_id'] ?>" class="row-cell _500 p-a text-warning">Choose</a>
