  ...
  if(isset($_POST['yes']))
    {
      $string = '00-auto-';
        ...
        {
            $query = "DROP TABLE `$contest_name`";
            $result = mysqli_query($connection, $query);
            if(mysqli_affected_rows($connection)==0)
            {

              $event_args = $row['contest_name'].' was removed from '.$rowEventName['event_name'];
              $status = 'Removed';
...
<div class="padding">
  ...
  <form id="custom2" name="form" class="form-group column" action="" ui-jp="parsley" method="post"><br><center><div style="font-size:  75px; padding-top: 75px;" ><span class="fa  fa-flash text-warn"></span></div>
    <h2 class="" style="font-style: 50px; padding-top: 0px;"><span class="text-warning">Are you sure you want to remove <strong><?php echo $rowContest['contest_name']?></strong>?</center></span></h2><br>
   <center><div class="form-group row">
      ...
      <div class="col-sm-10">
        <div class="row">
          ...
          <div class="col-md-2">
         <button type="submit"  name="yes" class="btn rounded white btn-block">Remove</button>
       </div>
