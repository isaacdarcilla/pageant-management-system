...
////ENTER 
    ...
    if(isset($_POST['start']))
    {
        ...
        $query = "SELECT invite_code, event_id
                    FROM event_table  
        ...
        if(mysqli_affected_rows($connection)==1)
        {
            ...
            header("Location:login.php?code=$invite_code&event_id=$event_id");
        }
        else
        {
            $message="Enter the <b>correct invite code.";
        }
        ...
        <div class="container ">
         ...
         <div class="collapse navbar-toggleable-sm text-left white" id="navbar-1">
            ...
            <ul class="nav navbar-nav nav-active-border top b-primary pull-right m-r-lg">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../">
                  <span class="nav-text text"><?php  session_destroy();  ?></span> 
                </a>
              </li>
            </ul>
            <!-- / link and dropdown -->
...
<div class="p-a-md primary p-y-lg"><br>
  <div class="padding">
    <h1 class="display-3 _500 l-s-n-2x" style="font-size: 40px; "><center>Audience Voting Page</b></center></h1>
  </div>
</div>      
      <div class="container p-y-lg text-primary-hover">

        <h5 class="text-muted m-b-lg">Event organizers will show you the <b>Invite Code</b>. </b> </h5>
 ...
 <p class="text-warning text-center"><?php  echo $message ?></p>          
  ...
  <form  method="post" ui-jp="parsley" action="">
    <div class="form-group row">
      <div class="col-sm-12">
        <input type="text" name="invite_code" class="form-control rounded"  placeholder="Enter Invite Code" required="true">
      </div>
    </div>

        <div class="form-group row">
           <div class="col-md-4 pull-right">
             <button type="submit" name="start" class="btn rounded warning btn-block">Next</button>
             </div>    
    </div>
   </form> 
